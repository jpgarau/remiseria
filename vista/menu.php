...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand text-warning text-uppercase" href="<?php echo SERVERURL;?>" style="font-family: 'Russo One', sans-serif;"><img src="img/favicon-32x32.png" alt="GESTION REMISES"></a>
